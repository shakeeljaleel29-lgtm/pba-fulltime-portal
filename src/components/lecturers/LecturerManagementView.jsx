...
const LecturerManagementViewInner = () => {
    ...
    <div>
      ...
      {selectedLecturer && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(10,15,28,0.55)", backdropFilter: "blur(4px)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div style={{ background: "#FFFFFF", borderRadius: "16px", padding: "28px", width: "100%", maxWidth: "700px", maxHeight: "85vh", overflowY: "auto", boxShadow: "0 24px 64px rgba(0,0,0,0.20)", position: "relative" }}>
            <button
          ...
          <div style={{ background: theme.cardBg, border: "1px solid " + theme.cardBorder, borderRadius: "14px", boxShadow: "0 2px 10px rgba(0,0,0,0.06)", overflow: "hidden" }}>
            ...
            <div style={{ padding: "20px 22px", display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              {paginatedRows.length > 0 ? (
                <div style={{ overflowX: 'auto', border: '1px solid #E3E6EA', borderRadius: '10px' }}>
